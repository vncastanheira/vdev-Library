Shader "vnc/Retro" {
		...
		_PrecisionW("Precision Width", Range(0.0, 200.0)) = 160.0
		_PrecisionH("Precision Height", Range(0.0, 200.0)) = 120.0
...
#include "UnityCG.cginc" 
	...
	v2f vert(appdata_full v)
	{
		...
		vertex.x = floor(_PrecisionW * vertex.x) / _PrecisionW;
		vertex.y = floor(_PrecisionH * vertex.y) / _PrecisionH;
